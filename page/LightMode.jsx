...
({ item }) {
    return (
        <div
            key={item.nim}
            className="flex md:flex-col border-2 rounded-lg bg-white border-gray-300 h-54 w-full items-center text-left md:w-1/4 lg:w-1/6 shadow-md"
        >
            <div className="bg-gray-200 md:border-b-2 rounded-l-lg md:rounded-bl-none md:rounded-t-lg h-full flex justify-center items-center w-1/3 sm:w-1/3 md:w-full lg:w-full">
                <img
                    src={item.foto || 'profile.png'}
                    className="border-2 border-gray-300 rounded-full object-cover h-32 w-32 m-2"
                />
            </div>
            <div className="h-42 flex flex-col justify-between md:rounded-t-none md:rounded-bl-lg rounded-r-lg bg-gray-100 text-gray-800 p-2.5 w-full">
                <div>
                ...
                <div className="overflow-hidden overflow-y-auto w-full py-2 flex flex-col space-y-1 text-[9px] font-bold font-mono no-scrollbar h-28">
                ...
                <button className="mt-2 rounded text-center px-2 py-1 bg-blue-500 hover:bg-blue-700 text-white text-xs font-bold">
                    Detail
                </button>
            </div>
        </div>
