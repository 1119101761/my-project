...
export default function Biodata({ item }) {
    ...
    return (
        ...
        `}
        >
            <div className={`${darkMode ? 'border-b-2 border-gray-600' : 'border-2 border-b-gray-500'} lg:row-span-2 p-2   flex justify-center items-center`}>
                <img
                    src={item.foto}
                    alt="Profile"
            ...
            <div className={`${darkMode ? 'bg-opacity-30 bg-black' : 'text-black'} relative py-2 px-4 absolute inset-0 `}>
